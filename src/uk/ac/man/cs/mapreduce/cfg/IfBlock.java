...
public class IfBlock extends AbstractBlock {
    ...
    private final CodeBlock condition, ifBody, elseBody;
    
    private final BranchInstruction instruction;
    
    public IfBlock(CodeBlock condition) {
        super();
        ...
        this.ifBody = (CodeBlock) start.getTrueSuccessor();
        
        this.elseBody = (CodeBlock) start.getFalseSuccessor();
    }
}
